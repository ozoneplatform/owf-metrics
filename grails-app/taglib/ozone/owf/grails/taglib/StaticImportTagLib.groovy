...
class StaticImportTagLib {
    ...
    // javascript from a 3rd party library, stored in js-lib    
    def jsLibrary = { attrs ->
    ...
    // 3rd party css included with a javascript library
    ...
    // 3rd party files included with a javascript library
