...
//    alert('fallback ifpc');
  ...
  function callIfpc(targetId, serviceName, from, rpcData, callArgs) {
    ...
    if (useLegacyProtocol[targetId]) {
      ...
      src = [relay, '#', encodeURIComponent(targetId), '&', from, '@', callId,
...
//    if (typeof sameDomain[target] === 'undefined') {
      ...
      if (target === '..') {
        ...
        targetEl = document.getElementById(target) != null ?
      ...
      switch (channelType) {
        case 'dpm': // use document.postMessage.
          ...
          var targetDoc = targetId === '..' ? parent.document :
                          (document.getElementById(targetId) != null ?
                           document.getElementById(targetId).document : null);
        ...
        case 'wpm': // use window.postMessage.
          ...
          var targetWin = targetId === '..' ? parent :
                          (document.getElementById(targetId) != null ?
                           document.getElementById(targetId).contentWindow : null);
          if (targetWin != null)
