<html>
	...
	<link rel="icon" type="image/png" href="images/logout/wfIcon.png" />
</head>
...
<div id="content">
  ...
  <div id="msgTop">
    <div id="logoutMsgHdr">Authentication Error</div>
    <div id="logoutMsg">You are not authorized to view this application. Please check your access and try again.</div>
  </div>
</div>
</body>
</html>